...
install_probot()
{
    ...
    install_logo_start
    echo -e "${Green_font_prefix}Start logo has installed to desktop."
    else
...
install_logo_start()
{
 cp src/probot_${robot_name}/logofiles/start.desktop ~/Desktop/start_${robot_name}.desktop

 if [ $robot_name = "anno" ]; then
       sed -i 's/rob_name="anno"/rob_name="anno"/g' src/probot_${robot_name}/logofiles/filename.sh
       sed -i 's/PROBOT Studio/PROBOT Studio-Anno/g' ~/Desktop/start_${robot_name}.desktop
       sed -i '3aExec=/home/tianbot/probot_anno_ws/src/probot_anno/logofiles/launch.sh' ~/Desktop/start_${robot_name}.desktop
       sed -i '4aIcon=/home/tianbot/probot_anno_ws/src/probot_anno/logofiles/pic.png' ~/Desktop/start_${robot_name}.desktop
       sed -i 's/probot_anno/probot_anno/g'  src/probot_${robot_name}/logofiles/launch.sh
    elif [ $robot_name = "g750" ]; then
       sed -i 's/rob_name="anno"/rob_name="g750"/g' src/probot_${robot_name}/logofiles/filename.sh
       sed -i 's/PROBOT Studio/PROBOT Studio-G750/g' ~/Desktop/start_${robot_name}.desktop
       sed -i '3aExec=/home/tianbot/probot_g750_ws/src/probot_g750/logofiles/launch.sh' ~/Desktop/start_${robot_name}.desktop
       sed -i '4aIcon=/home/tianbot/probot_g750_ws/src/probot_g750/logofiles/pic.png' ~/Desktop/start_${robot_name}.desktop
       sed -i 's/probot_anno/probot_g750/g' src/probot_${robot_name}/logofiles/launch.sh
    elif [ $robot_name = "g602" ]; then
       sed -i 's/rob_name="anno"/rob_name="g602"/g' src/probot_${robot_name}/logofiles/filename.sh
       sed -i 's/PROBOT Studio/PROBOT Studio-G602/g' ~/Desktop/start_${robot_name}.desktop
       sed -i '3aExec=/home/tianbot/probot_g602_ws/src/probot_g602/logofiles/launch.sh' ~/Desktop/start_${robot_name}.desktop
       sed -i '4aIcon=/home/tianbot/probot_g602_ws/src/probot_g602/logofiles/pic.png' ~/Desktop/start_${robot_name}.desktop
       sed -i 's/probot_anno/probot_g602/g' src/probot_${robot_name}/logofiles/launch.sh
    elif [ $robot_name = "c800" ]; then
       sed -i 's/rob_name="anno"/rob_name="c800"/g' src/probot_${robot_name}/logofiles/filename.sh
       sed -i 's/PROBOT Studio/PROBOT Studio-C800/g' ~/Desktop/start_${robot_name}.desktop
       sed -i '3aExec=/home/tianbot/probot_c800_ws/src/probot_c800/logofiles/launch.sh' ~/Desktop/start_${robot_name}.desktop
       sed -i '4aIcon=/home/tianbot/probot_c800_ws/src/probot_c800/logofiles/pic.png' ~/Desktop/start_${robot_name}.desktop
       sed -i 's/probot_anno/probot_c800/g' src/probot_${robot_name}/logofiles/launch.sh
    elif [ $robot_name = "g603" ]; then
       sed -i 's/rob_name="anno"/rob_name="g603"/g' src/probot_${robot_name}/logofiles/filename.sh
       sed -i 's/PROBOT Studio/PROBOT Studio-G603/g' ~/Desktop/start_${robot_name}.desktop
       sed -i '3aExec=/home/tianbot/probot_g603_ws/src/probot_g603/logofiles/launch.sh' ~/Desktop/start_${robot_name}.desktop
       sed -i '4aIcon=/home/tianbot/probot_g603_ws/src/probot_g603/logofiles/pic.png' ~/Desktop/start_${robot_name}.desktop
       sed -i 's/probot_anno/probot_g603/g' src/probot_${robot_name}/logofiles/launch.sh
    fi

    chmod +x ~/Desktop/start_${robot_name}.desktop
    chmod +x src/probot_${robot_name}/logofiles/*
}
